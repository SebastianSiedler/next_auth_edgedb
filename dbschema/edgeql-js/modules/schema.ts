...
export type $Object_190dbb9a150911edb29f09418a943953λShape = $.typeutil.flatten<_std.$BaseObjectλShape & {
...
type $Object_190dbb9a150911edb29f09418a943953 = $.ObjectType<"schema::Object", $Object_190dbb9a150911edb29f09418a943953λShape, null>;
...
export type $SubclassableObjectλShape = $.typeutil.flatten<$Object_190dbb9a150911edb29f09418a943953λShape & {
...
export type $AnnotationSubjectλShape = $.typeutil.flatten<$Object_190dbb9a150911edb29f09418a943953λShape & {
...
export type $VolatilitySubjectλShape = $.typeutil.flatten<$Object_190dbb9a150911edb29f09418a943953λShape & {
...
export type $ConsistencySubjectλShape = $.typeutil.flatten<$Object_190dbb9a150911edb29f09418a943953λShape & $InheritingObjectλShape & $AnnotationSubjectλShape & {
...
export type $DeltaλShape = $.typeutil.flatten<$Object_190dbb9a150911edb29f09418a943953λShape & {
...
export type $ExtensionλShape = $.typeutil.flatten<$AnnotationSubjectλShape & $Object_190dbb9a150911edb29f09418a943953λShape & {
...
export type $SourceλShape = $.typeutil.flatten<$Object_190dbb9a150911edb29f09418a943953λShape & {
...
export type $MigrationλShape = $.typeutil.flatten<$AnnotationSubjectλShape & $Object_190dbb9a150911edb29f09418a943953λShape & {
...
export type $ModuleλShape = $.typeutil.flatten<$Object_190dbb9a150911edb29f09418a943953λShape & $AnnotationSubjectλShape & {
}>;
...
export type $ParameterλShape = $.typeutil.flatten<$Object_190dbb9a150911edb29f09418a943953λShape & {
  "type": $.LinkDesc<$Type, $.Cardinality.One, {}, false, false,  false, false>;
