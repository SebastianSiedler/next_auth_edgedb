...
const JsonEmpty: $JsonEmpty = $.makeType<$JsonEmpty>(_.spec, "16f8c330-1509-11ed-9b7d-ad16e3379379", _.syntax.literal);
...
const $sequence: $sequence = $.makeType<$sequence>(_.spec, "11638bc2-1509-11ed-a034-95f884e6589a", _.syntax.literal);
...
const $BaseObject = $.makeType<$BaseObject>(_.spec, "1885eb9d-1509-11ed-92e0-d37f6885e4cb", _.syntax.literal);
...
export type $Object_188bed8e150911eda3afcf443ef691deλShape = $.typeutil.flatten<$BaseObjectλShape & {
}>;
type $Object_188bed8e150911eda3afcf443ef691de = $.ObjectType<"std::Object", $Object_188bed8e150911eda3afcf443ef691deλShape, null>;
export type $Object = $Object_188bed8e150911eda3afcf443ef691de
const $Object_188bed8e150911eda3afcf443ef691de = $.makeType<$Object_188bed8e150911eda3afcf443ef691de>(_.spec, "188bed8e-1509-11ed-a3af-cf443ef691de", _.syntax.literal);

const Object_188bed8e150911eda3afcf443ef691de: $.$expr_PathNode<$.TypeSet<$Object_188bed8e150911eda3afcf443ef691de, $.Cardinality.Many>, null, true> = _.syntax.$PathNode($.$toSet($Object_188bed8e150911eda3afcf443ef691de, $.Cardinality.Many), null, true);
...
const $FreeObject = $.makeType<$FreeObject>(_.spec, "1892f0c0-1509-11ed-a05a-9df174f0ecd5", _.syntax.literal);
...
export { JsonEmpty, bigint, bool, bytes, datetime, decimal, duration, float32, float64, int16, int32, int64, json, $sequence, str, uuid, number, $BaseObject, BaseObject, $Object_188bed8e150911eda3afcf443ef691de, Object_188bed8e150911eda3afcf443ef691de, $FreeObject, FreeObject };
